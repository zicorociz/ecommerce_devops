...
const ProductPage = () => {
    ...
    const handleCart = (product) => {
      ...
      if(isProductExist){
        const upatedCart = cart.map(item => {
      ...
      <div className="lg:w-4/5 mx-auto flex flex-wrap">
        ...
        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          ...
          <div className="flex">
            ...
            <button onClick={() => {handleCart(product)}}  className="flex ml-auto text-white bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 rounded">
            Add to Cart
            </button>
